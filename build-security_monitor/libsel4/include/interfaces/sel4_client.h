 ...
 * @param[in] world_id The thread's world id (guardianos) 
 * @return @xmlonly <errorenumdesc/> @endxmlonly
 ...
 */
LIBSEL4_INLINE seL4_Error
seL4_TCB_Configure(seL4_TCB _service, seL4_Word fault_ep, seL4_CNode cspace_root, seL4_Word cspace_root_data, seL4_CPtr vspace_root, seL4_Word vspace_root_data, seL4_Word buffer, seL4_CPtr bufferFrame, seL4_Uint64 world_id)
{
	seL4_Error result;
